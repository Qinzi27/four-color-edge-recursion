...
2026-09-19 更新：[阶段锚定、当前母线侧名与既有研究的有界对照](RELATED_WORK_UPDATE-2026-09-19.md)。
新增树文法后续、2025重配置期刊版及2026近线性算法预印本核对；旧访问记录按当时范围保留。

2026-09-07 更新：[对原方法、网页贪心基线、先行文法及发展方向的专项核对](METHOD_REVIEW-2026-09-07.md)。
该补充包含 Kauffman 1990/2005、Cori–Dulucq 1986、颜色置换去重以及冻结旧色分面反例。
