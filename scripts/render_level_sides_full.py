...
from scripts.validate_level_sides import POLICY, restart_level_side_names, verify_run
...
def main():
    ...
    write_report(args.output_dir / "manifest.json", {
        ...
        "source_sha256": {p: file_sha(ROOT / p) for p in (
            "scripts/render_level_sides_full.py", "scripts/render_level_sides.py", "scripts/render_frontier_restart.py",
